  ...
  <body>
    ...
    <div class="container">
      <form id="frm" class="form-signin" action="${pageContext.request.contextPath}/login" method="post">
        ...
        <h2 class="form-signin-heading">게시판 메인</h2>
        
        <label for="inputEmail" class="sr-only">userId</label>
        
        <input type="text" id="userId" name="userId" class="form-control" placeholder="userId" required value="bumwhi">
        
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="password" name="password" value="film24" class="form-control" placeholder="Password" required>
        <div class="checkbox">
          <label>
